 ...
 * PA5  - ARD_D13 SPI1_SCK          (input pullup). - Analog AZ
 * PA6  - ARD_D12 SPI1_MISO         (input pullup). - Analog EL
 * PA7  - ARD_D11 SPI1_MOSI ZIO_D71 RMII_RX_DV(alternate 11).
 * PA8  - USB_SOF                   (alternate 10). - AZ X
 * PA9  - USB_VBUS                  (analog).
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_ZIO_D32) |      \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOA_USB_SOF) |    \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_USB_SOF, 0) |       \
 ...
 * PB4  - ZIO_D25 SPI3_MISO         (input pullup). - EL X
 * PB5  - ZIO_D22 I2S3_SD           (input pullup). - EL Y
 ...
 * PB10 - ZIO_D36 TIM2_CH3          (input pullup). - AZ Y
