...
#define BOARD_NAME                  "ST STM32 Nucleo144-F429ZI"
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_USB_SOF, 0U) |      \
 ...
 * PB4  - ZIO_D25 SPI3_MISO         (input pullup). - AZ CCW
 * PB5  - ZIO_D22 I2S3_SD           (input pullup). - EL DN
 ...
 * PB10 - ZIO_D36 TIM2_CH3          (input pullup). - AZ CW
